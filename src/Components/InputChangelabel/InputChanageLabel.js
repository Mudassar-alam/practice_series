...
const inputHandler = (e)=>{
    ...
    const onsubmitform = (e)=>{
        ...
        setData({...data,fname:'',lname:'',email:'',phone:'',password:''})

        if(setData({...data,fname:'',lname:'',email:'',phone:'',password:''})){
    ...
    return(
        <>
            ...
            <div id="body">
            <h1>Floating <span> Label</span></h1>
                    <form onSubmit={onsubmitform}>
                    <div id="input-div">
                        <input type='text' id="fname" placeholder=' ' value={data.fname} onChange={inputHandler} autoComplete='off' />
                        <label id="labelFName">First Name</label>
                        </div>
                        <div id="input-div">
                        <input type='text' id='lname' placeholder=" "  value={data.lname} onChange={inputHandler} autoComplete='off' />
                        <label id="labelLName">Last Name</label>
                        </div>
                        <div id="input-div">
                        <input type='email' id="email" placeholder=" " value={data.email} onChange={inputHandler} autoComplete='off'/>
                        <label id="labelEmail">Email</label>
                        </div>
                       <div id="input-div">
                        <input type='phone' id="phone" placeholder=" " value={data.phone} onChange={inputHandler} autoComplete='off' />
                        <label id="labelPhone">Phone No</label>
                        </div>
                        <div id="input-div">
                        <input type='password' id="password" placeholder=" " value={data.password} onChange={inputHandler} autoComplete='off'/>
